		...
		$sections['shop'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'sub_desc' 	=> __('deprecated since WooCommerce 2.7', 'mfn-opts'),
					'desc' 		=> __('<b>deprecated:</b> Since WooCommerce 2.7 new product gallery has been merged in to core', 'mfn-opts'),
					'options' 	=> array(
						'' 			=> __('- Default -', 'mfn-opts'),
						'plugin'	=> __('Use external plugin for featured images', 'mfn-opts'),
					),
			...
			'fields'	=> array(
				...
				array(
					...
					'options' 	=> array(
						...
						'message' 	=> __('Full error message below filed', 'mfn-opts'),
					),
				),
				...
				array(
					...
					'desc' 		=> __('Nice Scroll does not support Ctrl+F properly', 'mfn-opts'),
					'options' 	=> array(
