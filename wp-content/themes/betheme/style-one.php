...
#Subheader {
	...
	?>
	background-color: <?php hex2rgba( '#F7F7F7', $subheaderA, true ); ?>;
}
...
/* Links color */
	...
	a:hover {
		color: <?php hex2rgba( $color_one, 0.8 ,1 ); ?>;
	}
...
/* Fancy Link */
	...
	a.mfn-link-6:before {
		border-bottom-color: <?php echo $color_one; ?>;
	}
...
/* Shop buttons */
	...
	.button-stroke.woocommerce-page input.button{
		border: 2px solid <?php echo $color_one; ?> !important;
		color: <?php echo $color_one; ?> !important;
	}
...
/* ============================================================================================================================ */
	...
	#Overlay {
		background: <?php hex2rgba( $color_one, .95, true ) ?>;
	}
...
.woocommerce span.onsale, .shop_slider .shop_slider_ul li .item_wrapper span.onsale {
	border-top-color: <?php echo $color_one; ?> !important;
}
.woocommerce .widget_price_filter .ui-slider .ui-slider-handle {
	border-color: <?php echo $color_one; ?> !important;
}	
